...
<div class="p-4 sm:p-6 max-w-5xl mx-auto">
    ...
    <form action="{{ route('admin.pembelians.store') }}" method="POST" id="form-pembelian" class="space-y-4">
        ...
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700/60 rounded-lg p-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" value="{{ date('Y-m-d') }}" class="w-full bg-slate-700/50 border border-slate-700 text-white px-3 py-2 rounded-lg text-sm focus:outline-none focus:border-blue-500">
                </div>
                <div>
                ...
                <table class="min-w-full text-xs">
                    ...
                    <tbody id="produk-rows" class="divide-y divide-slate-700">
                        <tr class="produk-row">
                            ...
                            <td class="px-3 py-2"><input type="number" name="kuantitas[]" step="0.01" min="0" value="1" class="w-full bg-slate-700/50 border border-slate-700 text-white px-2 py-1 rounded text-xs input-qty"></td>
                            <td class="px-3 py-2"><input type="number" name="harga_satuan[]" step="0.01" min="0" value="0" class="w-full bg-slate-700/50 border border-slate-700 text-white px-2 py-1 rounded text-xs input-harga"></td>
        ...
        <div>
            ...
            <textarea name="keterangan" class="w-full bg-slate-700/50 border border-slate-700 text-white px-3 py-2 rounded-lg text-sm focus:outline-none focus:border-blue-500" rows="2"></textarea>
        </div>

        <div class="flex gap-3">
            <button type="submit" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg text-sm">Simpan</button>
