...
<div class="min-h-screen bg-slate-900">
    <div class="p-4 md:p-6 lg:p-8">
        <h1 class="text-2xl md:text-3xl font-bold text-slate-100 mb-6">Buat Kuitansi Baru</h1>

        <div class="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
            <form action="{{ route('admin.kuitansi.store') }}" method="POST">
                @csrf
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_kuitansi" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500" required>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-2">Tanggal Pembayaran <span class="text-red-400">*</span></label>
                        <input type="date" name="tanggal_pembayaran" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500" required>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-2">Metode Pembayaran <span class="text-red-400">*</span></label>
                        <input type="text" name="metode_pembayaran" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500" required>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-2">Jumlah Dibayar <span class="text-red-400">*</span></label>
                        <input type="number" name="jumlah_dibayar" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500" required>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-2">Tanda Tangan Penerima <span class="text-red-400">*</span></label>
                        <input type="text" name="tanda_tangan_penerima" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500" required>
                    </div>
                </div>
