    ...
    <div class="min-h-screen bg-slate-900 p-4 md:p-6">
        <div class="max-w-7xl mx-auto">
            <div class="mb-6 flex items-start justify-between">
                ...
                <a href="{{ route('admin.jurnal-umum.import.form') }}"
                        ...
                        <div
                            ...
                            <form id="adjustForm" method="POST">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="date" name="tanggal_transaksi" id="modal_tanggal"
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" name="debit" id="modal_debit"
                                                class="w-full bg-slate-700 border-slate-600 rounded text-slate-100">
                                        </div>
                                        <div>
                                            <label class="block text-sm text-slate-400 mb-1">Kredit</label>
                                            <input type="number" name="kredit" id="modal_kredit"
                                                class="w-full bg-slate-700 border-slate-600 rounded text-slate-100">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 flex justify-end gap-3">
                                    ...
                                    <button type="submit"
                                        class="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded">Simpan
                                        Penyesuaian</button>
                                </div>
                            </form>
                        </div>
