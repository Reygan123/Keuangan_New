                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <select name="akun_aset_id" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" required>
                            ...
                            <option value="{{ $akun->id }}" {{ $aset->akun_aset_id == $akun->id ? 'selected' : '' }}>{{ $akun->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="uraian" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white placeholder-slate-400 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" value="{{ $aset->uraian }}" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="tgl_perolehan" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" value="{{ $aset->tgl_perolehan }}" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="harga_beli" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white placeholder-slate-400 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" step="0.01" value="{{ $aset->harga_beli }}" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="golongan" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white placeholder-slate-400 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" value="{{ $aset->golongan }}" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="umur_ekonomis" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white placeholder-slate-400 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" value="{{ $aset->umur_ekonomis }}" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="nilai_sisa" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white placeholder-slate-400 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" step="0.01" value="{{ $aset->nilai_sisa }}" required>
                    ...
                    <div>
                        ...
                        <select name="akun_beban_id" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" required>
                            ...
                            <option value="{{ $akun->id }}" {{ $aset->akun_beban_id == $akun->id ? 'selected' : '' }}>{{ $akun->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="akun_akumulasi_id" class="w-full px-3 py-2 text-xs sm:text-sm bg-slate-700/50 border border-slate-600/50 text-white rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all" required>
                            ...
                            <option value="{{ $akun->id }}" {{ $aset->akun_akumulasi_id == $akun->id ? 'selected' : '' }}>{{ $akun->name }}</option>
                            @endforeach
                        </select>
