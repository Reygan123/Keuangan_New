...
<div class="min-h-screen bg-slate-900">
    <div class="p-4 md:p-6 lg:p-8">
        <h1 class="text-2xl md:text-3xl font-bold text-slate-100 mb-6">Buat Invoice Baru</h1>
        ...
        <div class="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
            <form action="{{ route('admin.invoices.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text" name="nomor_invoice" id="nomor_invoice" value="{{ old('nomor_invoice') }}" class="flex-1 px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500 @error('nomor_invoice') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_jatuh_tempo" value="{{ old('tanggal_jatuh_tempo') }}" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500 @error('tanggal_jatuh_tempo') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="number" name="jumlah_pajak" id="jumlah_pajak" value="{{ old('jumlah_pajak', 0) }}" class="flex-1 px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-r-lg focus:outline-none focus:border-blue-500" min="0" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="terms_pembayaran" rows="2" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500">{{ old('terms_pembayaran') }}</textarea>
                ...
                <div class="px-6 py-4 border-t border-slate-700 bg-slate-700/30 flex gap-3 justify-end">
                    <a href="{{ route('admin.invoices.index') }}" class="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-slate-200 text-sm font-medium rounded-lg transition">Batal</a>
