...
<div class="min-h-screen bg-slate-900">
    <div class="p-4 md:p-6 lg:p-8">
        ...
        <div class="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
            <form action="{{ route('admin.invoices.store', ['usaha_id' => $currentUsaha?->id]) }}" method="POST" id="invoiceForm">
                @csrf
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="transaksi_id" id="transaksi_id" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500 @error('transaksi_id') border-red-500 @enderror" {{ !$currentUsaha ? 'disabled' : '' }}>
                        ...
                        <div id="additionalFields" class="hidden md:col-span-2 space-y-4 bg-slate-700/50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="to_client_name" id="to_client_name" value="{{ old('to_client_name') }}" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-slate-300 mb-2">Nama Bank</label>
                                    <input type="text" name="nama_bank" id="nama_bank" value="{{ old('nama_bank') }}" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-slate-300 mb-2">Nomor Rekening</label>
                                    <input type="text" name="nomor_rekening" id="nomor_rekening" value="{{ old('nomor_rekening') }}" class="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg focus:outline-none focus:border-blue-500">
                                </div>
                            </div>
                        </div>
